...
##   $ docker build -t node-js-for-mikeshermetaro-meanstreak .
##
## RUNNING
##   $ docker run -p 3000:3000 node-js-for-mikeshermetaro-meanstreak
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="kzae4vm" \
    STACKSMITH_STACK_NAME="Node.js for MikeShermetaro/meanstreak" \
